...
async def imagem(ctx, *, prompt: str = None):
    ...
    if not dados:
        return await msg.edit(content="❌ As APIs gratuitas bloquearam o bot por excesso de uso. Crie uma conta em fal.ai e configure o FAL_KEY no arquivo .env para voltar a gerar imagens.")
